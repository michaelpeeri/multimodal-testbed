...
(see _CONFIG_DEFAULTS for the rest / defaults):
    target_stats_path     : str|None, default None -- path to a pickle file
                            ...
                            pca_standardized_* family added 20260816, see
                            AGENTS.md) -- it already stores whatever that
                            ...
                            separately for the raw-PCA and standardized-PCA
                            families if either is missing/stale).
